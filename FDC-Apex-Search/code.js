...
//		d.onmousedown = function(e) { window.location.href = results[e.target.id].getAttribute('Source') };
	...
	document.title = 'Apex Docs: '+searchText;
	
}

function addStemResults(index) {
	var stemhttp = new XMLHttpRequest();
	stemhttp.open("GET", "http://www.salesforce.com/us/developer/docs/apexcode/Data/"+stems[index].getAttribute('chunk'),true);
...
if(document.getElementById('SearchResults')) { 
	...
	document.title = 'Searching Apex Docs: '+searchText;
	...
	xmlhttp.open("GET", "http://www.salesforce.com/us/developer/docs/apexcode/Data/Search.xml",true);
