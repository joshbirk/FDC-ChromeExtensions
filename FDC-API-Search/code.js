...
//		d.onmousedown = function(e) { window.location.href = results[e.target.id].getAttribute('Source') };
	...
	document.title = 'API Docs: '+searchText;
	
}

function addStemResults(index) {
	var stemhttp = new XMLHttpRequest();
	stemhttp.open("GET", "http://www.salesforce.com/us/developer/docs/api/Data/"+stems[index].getAttribute('chunk'),true);
...
if(document.getElementById('SearchResults')) { 
	...
	document.title = 'Searching API Docs: '+searchText;
	...
	xmlhttp.open("GET", "http://www.salesforce.com/us/developer/docs/api/Data/Search.xml",true);
